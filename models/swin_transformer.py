...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str,
                 ...
                 pretrained: str = None):
        assert name in ['swin_t_p4w7', 'swin_s_p4w7', 'swin_b_p4w7', 'swin_l_p4w7', 'swin_l_p4w12']
        cfgs = configs[name]
...
def build_swin_backbone(config):
    position_embedding = build_position_encoding(config)
    # if  args.backbone == 'swin_l_p4w12':
    #     pretrain_path = 'weights/swin_large_patch4_window12_384_22k.pth'
    # else:
    #     pretrain_path = None
    pretrain_path = None

    backbone = Backbone(config.MODEL.ENCODER.BACKBONE, False, pretrain_path)
...
configs = {
    ...
    'swin_l_p4w7': dict(embed_dim=192,
                        ...
                        out_indices=(0, 1, 2, 3),
                        use_checkpoint=False),
    'swin_l_p4w12': dict(embed_dim=192,
                         depths=[2, 2, 18, 2],
                         num_heads=[6, 12, 24, 48],
